...
function App() {
    ...
    const API_BASE_URL = import.meta.env.NODE_ENV === 'production' ? 'https://footy-picker-58753c2f9639.herokuapp.com/api' : 'http://localhost:5000/api';
        ...
        >
            <div className="App">
                ...
                <div className="content">
                    <div style={{ borderBottom: '1px solid black', marginBottom: 8, width: '100%' }}>
                        <h4 style={{ marginTop: 0 }}>Footy Picker</h4>
                    </div>
                    {isAuthenticated ? renderContent() : <p>Please log in to see the content.</p>}
                </div>
