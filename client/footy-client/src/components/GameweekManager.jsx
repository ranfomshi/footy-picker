...
const GameweekManager = () => {
  ...
  return (
    <div>
      <Button size="small" type="primary" onClick={showAddGameweekModal}>
        Add Gameweek
      </Button>
      <Spin spinning={loadingGameweeks || loadingPlayers}>
        <List
          ...
          dataSource={Object.values(gameweeks).sort(
                    ...
                    <Spin spinning={loadingTeams[gameweek.id]}>
                        ...
                        {players.map((player) => (
                          ...
                          >
                            ...
                            <Switch
                              ...
                              checked={
                                availability[gameweek.id] &&
                                availability[gameweek.id][player.id]
                              }
                              onChange={(checked) =>
                      ...
                      >
                        <Popconfirm
                          ...
                          disabled={resultExists}
                        >
                          <Button size="small" type="primary" danger disabled={resultExists}>
                            <DeleteOutline />
                          </Button>
                        </Popconfirm>
                        <Button
